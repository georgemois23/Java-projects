...
public class GUI extends JFrame {
    ...
    public GUI() {
        ...
        //geia sas me lene gewrgio
        // balte m 10!
        panel.add(findpanel);
        findpanel.setBorder(BorderFactory.createEmptyBorder(30, 30, 10, 30));
        OriginAirportCity = new JTextField(20);
        findpanel.add(OriginAirportCity);
        JButton findbutton = new JButton("Find");
        JButton Visualisebutton = new JButton("Visualize Network");
//        Visualisebutton.setPreferredSize(new Dimension(100, 30)); // Adjust the dimensions as needed
        JPanel visualisepanel= new JPanel();
        visualisepanel.setSize(100,300);
        visualisepanel.add(Visualisebutton);
        
        add(panel);
        panel.add(visualisepanel);
...
//                    System.out.println(CentralRegistry.CityAirport(userInput).getAirlines());
                    ...
                    String directflights,indirectflights;//for txt file
                    ...
                    directflights="DIRECT FLIGHTS DETAILS\n"+CentralRegistry.getDirectFlightsDetails(findflightuser, originaluserinput);}
                  //if the two airports does not have direct flights
                   ...
                   // box1.add(new TextArea("Hello"));
                    ...
                    indirectflights="INDIRECT FLIGHTS through...\n"+CentralRegistry.getInDirectFlightsDetails(findflightuser, originaluserinput);}
                    else {
                    ...
                    try
            		{
                    	String fileName = userInput + "to" + findflight + ".txt";
            			File f = new File(fileName);
            			FileWriter writer = new FileWriter(f);
            			
            			writer.write("CITY: "+userInput+", "+CentralRegistry.CityAirport(userInput).getCountry());
            			writer.write(System.lineSeparator());
            			writer.write("Airport: "+CentralRegistry.CityAirport(userInput).getName()+" ("+CentralRegistry.CityAirport(userInput).getCode()+")");
            			writer.write(System.lineSeparator());
            			writer.write(System.lineSeparator());
            			writer.write("Destination: "+findflight);
            			writer.write(System.lineSeparator());
            			writer.write(System.lineSeparator());
